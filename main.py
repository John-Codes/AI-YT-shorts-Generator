...
for i, sentence in enumerate(sentences):
    ...
    base_image_path = os.path.join("output", "AIBackgroundImage", f'sentence_{i}.png')
    generate_image(text_content=[sentence], output_path=os.path.join("output", "AIBackgroundImage", f'sentence_{i}.png')) # Generate base image
